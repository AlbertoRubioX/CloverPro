...
namespace Logica
{
    public class KanbanPlanLogica
    {
        ...
        public static int Guardar(KanbanPlanLogica kan)
        {
            ...
            return AccesoDatos.Actualizar("sp_mant_kanban_plan", parametros, kan.Linea, kan.Descrip, kan.CantT1, kan.CantT2, kan.Usuario);
        }
        ...
        public static DataTable Consultar()
        {
            ...
            try
            {
                datos = AccesoDatos.Consultar("SELECT * FROM t_kanban_plan order by line");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static DataTable Listar()
        {
            ...
            try
            {
                datos = AccesoDatos.Consultar("select linea as LINEA,descrip as NOMBRE,ind_1t,cant_1t as [1ER TURNO],ind_2t,cant_2t as [2DO TURNO],'0' from t_kanban_plan order by linea");
            }
            catch (Exception ex)
            {
                throw ex;
