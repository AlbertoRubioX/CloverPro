...
namespace CloverPro
{
    public partial class wfRepLineUp : Form
    {
        private string _lsProceso = "REP030";
        ...
        private void Inicio()
        {
            ...
            rbtFolioT.Checked = true;
            rbtFolioU.Checked = false;
            rbtFolioA.Checked = false;
            lblFIni.Visible = false;
            txtFolioIni.Visible = false;
            lblFFin.Visible = false;
            txtFolioFin.Visible = false;

            rbtLineaT.Checked = false;
            rbtLineaU.Checked = false;
            rbtLineaA.Checked = true;
            /*
            ...
            */
            ...
            chbBloqImp.Enabled = false;
            chbBloqImp.Checked = true;

            if (UsuarioLogica.VerificarPermiso(GlobalVar.gsUsuario, _lsProceso + "20") == true)
            {
                chbBloqImp.Enabled = true;
            }

            if (GlobalVar.gsPlanta == "COL" || GlobalVar.gsPlanta == "FUS")
            {
                chbBloqImp.Enabled = true;
                chbBloqImp.Checked = false;
            }
        ...
        private bool Valida()
        {
            ...
            if(rbtFolioU.Checked && string.IsNullOrEmpty(txtFolioIni.Text))
            {
                MessageBox.Show("Favor de espeficicar el Folio", Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtFolioIni.Focus();
                return bValida;
            }

            if (rbtFolioA.Checked && (string.IsNullOrEmpty(txtFolioIni.Text) || string.IsNullOrEmpty(txtFolioFin.Text)))
            {
                MessageBox.Show("Favor de espeficicar rengo de Folios", Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtFolioIni.Focus();
                return bValida;
            }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            string sIndF = "T";
            if (rbtFolioA.Checked)
                sIndF = "A";          
            if (rbtFolioU.Checked)
                sIndF = "U";
            ...
            Impresor._lsIndFolio = sIndF;
            Impresor._lsFolioIni = txtFolioIni.Text.ToString();
            Impresor._lsFolioFin = txtFolioFin.Text.ToString();
            ...
            /*if (cbbLineaFin.SelectedIndex != -1)
                Impresor._lsLineaFin = cbbLineaFin.SelectedValue.ToString();*/
            ...
            if (chbBloqImp.Checked)
                Impresor._lsBloqImp = "S";
            else
                Impresor._lsBloqImp = "N";

            if (chbBloqOper.Checked)
                Impresor._lsImpOperBloq = "S";
            else
                Impresor._lsImpOperBloq = "N";
        ...
        private void rbtFolioU_CheckedChanged(object sender, EventArgs e)
        {
            if(rbtFolioU.Checked)
            {
                rbtFolioT.Checked = false;
                rbtFolioA.Checked = false;
                lblFIni.Text = "Folio:";
                lblFIni.Visible = true;
                txtFolioIni.Visible = true;
                lblFFin.Visible = false;
                txtFolioFin.Visible = false;
            }
        }

        private void rbtFolioA_CheckedChanged(object sender, EventArgs e)
        {
            if(rbtFolioA.Checked)
            {
                rbtFolioU.Checked = false;
                rbtFolioT.Checked = false;
                lblFIni.Text = "Folio Inicial:";
                lblFIni.Visible = true;
                txtFolioIni.Visible = true;
        ...
        private void chbBloqImp_CheckedChanged(object sender, EventArgs e)
        {
            if(!chbBloqImp.Checked)
                chbBloqOper.Checked = false;
        }
    }
}
