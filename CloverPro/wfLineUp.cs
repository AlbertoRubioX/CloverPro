...
namespace CloverPro
{
    public partial class wfLineUp : Form
    {
        ...
        public wfLineUp(string _asParam)
        {
            InitializeComponent();
            _lsParam = _asParam;
        ...
        #region regInicio
        private void wfLineUp_Load(object sender, EventArgs e)
        {
            Inicio();
        ...
        private void Inicio()
        {
            ...
            if (UsuarioLogica.VerificarPermiso(GlobalVar.gsUsuario, _lsProceso + "80") == true)
        ...
        private void wfLineUp_Activated(object sender, EventArgs e)
        {
        ...
        private bool Valida()
        {
            ...
            foreach (DataGridViewRow row in dgwEstaciones.Rows)
            {
                ...
                if (string.IsNullOrEmpty(sLinea) && string.IsNullOrWhiteSpace(sLinea) && sOpe != "N/A")
                {
                    ...
                    dgwEstaciones.CurrentCell = dgwEstaciones[11, row.Index];
                    dgwEstaciones.Focus();
                    return bValida;
                }
            }
        ...
        private bool Guardar()
        {
            try
            {
                ...
                //else
                //    EnviarMail(line.Folio.ToString(),"G");
        ...
        private void btDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                long lFolio = 0;
                if (long.TryParse(tstFolio.Text, out lFolio))
                {
                    DialogResult Result = MessageBox.Show("Desea Borrar el Registro del LineUp?", "Confirmar Operación", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                ...
                {
                    MessageBox.Show("El Folio no es correcto", Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    tstFolio.Focus();
                    return;
                }
            }
            ...
            {
                Cursor = Cursors.Default;
                MessageBox.Show("Favor de notificar al Administrador" + Environment.NewLine + "LineUpLogica.Borrar(line)" + Environment.NewLine + ie.ToString(), Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
                Cursor = Cursors.Default;
            }
        }
        ...
        private void btnHelp_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    sDirec += @"\CloverPRO_ManualLineUp.pdf";
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(sOper) && !string.IsNullOrWhiteSpace(sOper))
                    {
                        ...
                        */
                        ...
                        //if(!bExiste && dgwEstaciones[9, e.RowIndex].Value.ToString() != "")
        ...
        private void btnF1_Click(object sender, EventArgs e)
        {
            if (dgwEstaciones.Rows.Count > 0)
            {
                MessageBox.Show("Favir de Limpiar pantalla antes de Cambiar de Linea", Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void wfLineUp_Resize(object sender, EventArgs e)
        {
